...
ALLOWED_HOSTS = ['linli-ding.appspot.com', 'localhost', '127.0.0.1', 'linli.me']
# ALLOWED_HOSTS = ['*']
...
INSTALLED_APPS = (
    ...
    # allows static page editing in admin site
    # 'ckeditor',
    # 'ckeditor_uploader',
...
DATABASES['default']['HOST'] = '/cloudsql/linli-ding:us-east1:projects-instance'
